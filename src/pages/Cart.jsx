...
function Cart() {
    ...
    const pizzasItems = Object.keys(items).map(key => {
            ...
            {totalCount ? (
                <div className="cart">
                    ...
                    <div className="content__items">
                        {pizzasItems.map((itemObj, index) => (
                            <CartItem
                                key={`cartIten_${index}`}
                                totalPrice={items[itemObj.id].totalPrice}
                                totalCount={items[itemObj.id].items.length}
